...
export default function Resume() {
  ...
  return (
    <div class="box-border dark:text-offwhite font-mono h-full mx-auto max-w-5xl pb-20 w-[86%]">
      ...
      <div class="box-border inline-block float-right w-full md:w-[38%] pb-20">
