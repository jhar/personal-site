    ...
    return (
        <div class="box-border font-mono h-full mx-auto max-w-5xl pb-15 w-[86%]">
            ...
            <div class="box-border inline-block float-right w-full md:w-[38%] mb-5">
                <span class="font-bold">Burbank, CA</span><br />
                <span class="font-bold">(626) 491-6947</span><br />
                <a
            ...
            <div class="box-border inline-block float-right w-full md:w-[38%] mb-12">
                ...
                {experience.professionalDevelopment.map(entry => <Experience {...entry} />)}
                <h3 class="text-blue text-lg">Skills</h3>
                <p class="mb-5">HTML, CSS, JavaScript, PHP, MySQL, MongoDB, Unix, Bootstrap, jQuery, React, Knockout, Vue, Node, NPM, Express, SASS, LESS, Firebase, AWS, Webpack, Browserify, Gulp, WordPress, p5.js, Processing, Chrome Developer Tools, AJAX, and Google.</p>
